<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giaynu.aspx.cs" Inherits="SneakerShop.WebForm5" %>
...
<body>
     <div class="header">
		...
		<div class="header_bot" id="header-bot">
			...
			<ul>
				...
				<li><a id="selected" href="giaynu.aspx">WOMEN'S</a></li>
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>HOME</strong></a> / <a href="giaynu.aspx"><strong>WOMEN'S SHOES</strong></a>
        </div>
    </div>
	<div class="container">
